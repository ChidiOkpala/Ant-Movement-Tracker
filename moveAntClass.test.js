...
describe('That the check limit functions return desired values', () => {
  test('the checkRightLimit returns false when ant is not at the extreme right line', () => {
    const position = 35
    let testAnt = new MoveAnt(position);
